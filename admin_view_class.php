                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            ...
                            <a class="btn btn-sm btn-light text-primary" href="admin_create_class.php?course_id=<?php echo $_GET['course_id'] ?>">
                            ...
                            while ($row = $stmt->fetch()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-datatable btn-icon btn-transparent-dark mx-2" href="admin_delete_class.php?course_id=<?php echo $row['course_id']?>&class_id=<?php echo $row['class_id'] ?>" title="Delete Class"><i data-feather="trash-2"></i></a>
