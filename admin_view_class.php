                                    ...
                                    <tbody>
                                        ...
                                        <tr> 
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-datatable btn-icon btn-transparent-dark" href="admin_view_enrollment.php?course_id=<?php echo $row['course_id']?>" title="View Class"><i data-feather="user"></i></a>
