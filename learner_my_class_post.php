                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        <h1 class="page-header-title">
                                            ...
                                            View <?php echo $course_id?> <?php echo $class_id?> Forum of Thread <?php echo $thread_id ?>
                                        </h1>
                                    ...
                                    <div class="col-12 col-xl-auto mt-4">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary "  href="learner_create_post.php?course_id=<?php echo $course_id?>&class_id=<?php echo $class_id?>&thread_id=<?php echo $thread_id?>">
