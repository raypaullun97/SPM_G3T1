                                            ...
                                            <form>
                                                ...
                                                <div class="row gx-3 mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" name = 'Class_ID' id="Class_ID"  type="text" placeholder="Enter your Class Name" value="" />
                                                    </div>
                                                    <!-- Form Group (Course Name)-->
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="Course_Name">Course Name</label>
                                                        <input class="form-control" name = 'Course_Name' id="Course_Name" type="text" placeholder="Enter your Course Name" value="<?php echo $_GET['course_id']?>"  />
                                                    </div>
                                                </div>
                                                <div class="row gx-3 mb-3">
                                                    <!-- Form Group (Course ID)-->
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" name = 'Capacity' id="Capacity"  type="number" placeholder="Enter capacity of the class" value="" />
                                                    </div>
                                                    <!-- Form Group (Course Name)-->
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="Day">Day</label>
                                                        <input class="form-control" name = 'Day' id="Day" type="number" placeholder="Enter number of days of the class" value="" />
                                                    </div>
                                                </div>
                                                <div class="row gx-3 mb-3">
                                                    <!-- Form Group (Course ID)-->
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" name = 'start_register_date' id="start_register_date"  type="date" placeholder="Enter Start Registration Date" value="" />
                                                    </div>
                                                    <!-- Form Group (Course Name)-->
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="end_register_date">End Registration Date</label>
                                                        <input class="form-control" name = 'end_register_date' id="end_register_date" type="date" placeholder="Enter End Registration Date" value="" />
                                                    </div>
                                                </div>
                                                <div class="row gx-3 mb-3">
                                                    <!-- Form Group (Course ID)-->
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" name = 'start_date' id="start_date"  type="date" placeholder="Enter Start Date" value="" />
                                                    </div>
                                                    <!-- Form Group (Course Name)-->
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="end__date">End Date</label>
                                                        <input class="form-control" name = 'end__date' id="end__date" type="date" placeholder="Enter End Date" value="" />
                                                    </div>
                                                </div>
                                                <div class="row gx-3 mb-3">
                                                    <!-- Form Group (Course ID)-->
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" name = 'start_time' id="start_time"  type="time" placeholder="Enter Start Time" value="" />
                                                    </div>
                                                    <!-- Form Group (Course Name)-->
                                                    <div class="col-md-6">
                                                        <label class="small mb-1" for="end_time">End Time</label>
                                                        <input class="form-control" name = 'end_time' id="end_time" type="time" placeholder="Enter End Time" value="" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" id="engineer_id" name="engineer_id">
