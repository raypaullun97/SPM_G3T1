<?php
    class ClassDAO{
        ...
        $end_date, $start_time, $end_time, $engineer_id) {
            ...
            $sql = "UPDATE class SET class_id=:class_id, course_id=:course_id, capacity=:capacity 
                    ...
                    , end_time=:end_time, engineer_id=:engineer_id WHERE class_id=:class_id and course_id =:course_id";
            $stmt = $pdo->prepare($sql);
