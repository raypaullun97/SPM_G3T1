            ...
            <div id="layoutSidenav_content">
                ...
                <div class = 'container'>
                    <div class= 'row'>
                        ...
                        <div class = 'col-sm-6'>
                            <a style='float:right' ya type="submit" class="btn btn-danger mt-2" id = "submit" name = "submit" onclick = "return confirm('Are you sure you want to leave the quiz?')" href = 'learner_my_class.php?course_id=<?php echo $course_id?>&class_id=<?php echo $class_id?>'>Leave</a>
                        </div>
                    </div>
                </div>
            </form>
